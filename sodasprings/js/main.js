...
const url = "https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=da3b68c843f01e78d91a043033def649&units=imperial"
fetch(url)
...
let fiveDayUrl = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&appid=da3b68c843f01e78d91a043033def649&units=imperial"
fetch(fiveDayUrl)
    .then((response) => response.json())
    .then((jsObject) => {
